...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lista todas as empresas que o usuário tem acesso' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de empresas retornada.' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, common_1.Patch)('switch-company'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Troca a empresa do contexto atual do usuário' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Empresa alterada com sucesso.' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Usuário não tem acesso à empresa.' }),
    ...
    __metadata("design:returntype", void 0)
], UsersController.prototype, "switchCompany", null);
