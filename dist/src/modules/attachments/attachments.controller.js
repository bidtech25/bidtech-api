...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Upload attachment to process' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all attachments for a process' }),
    __param(0, (0, common_1.Param)('processId')),
    __metadata("design:type", Function),
...
exports.AttachmentsController = AttachmentsController = __decorate([
    (0, swagger_1.ApiTags)('Process Attachments'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Controller)('processes/:processId/attachments'),
